...
import com.cscodetech.marwarimarts.fragment.Info1Fragment;
import com.cscodetech.marwarimarts.fragment.Info2Fragment;
import com.cscodetech.marwarimarts.fragment.Info3Fragment;
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_next) {
            if (selectPage == 0) {
                ...
                startActivity(new Intent(IntroActivity.this, CityActivity.class));
                finish();
            }
        }
    }

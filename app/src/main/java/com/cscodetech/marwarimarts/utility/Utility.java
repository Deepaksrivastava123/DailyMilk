...
import com.cscodetech.marwarimarts.MyApplication;
...
public class Utility {
    ...
    public static boolean internetChack() {
        ConnectivityManager service = (ConnectivityManager) MyApplication.mContext.getSystemService(Context.CONNECTIVITY_SERVICE);
